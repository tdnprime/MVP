<input name='address_line_1' type='text' required value='{{ $address->address_line_1 ?? '' }}'
    placeHolder='Street address' />
<input name='address_line_2' type='text' value='{{ $address->address_line_2 ?? '' }}'
    placeHolder='Address line 2 (optional)' />
<input name='admin_area_2' type='text' required value='{{ $address->admin_area_2 ?? '' }}' placeHolder='City' />
<input name='admin_area_1' type='text' required value='{{ $address->admin_area_1 ?? '' }}' placeHolder='State' />
<select required name='country_code' class='form-control' id='country'>
    <option value='{{ $address->country_code ?? '' }}'>{{ $address->country_code ?? 'Select your country' }} </option>
...
<input name='postal_code' type='text' required value='{{ $address->postal_code ?? '' }}' placeHolder='Postal code' />
