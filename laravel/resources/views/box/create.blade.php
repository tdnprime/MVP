        ...
        <form id='create-box' name='basics' action='/box' method='post'>
            ...
            <div class="row">
                <div class="col-75">
                    ...
                    <div>
                        <p>We recommend going with the average price of a subscription box, which is USD 35, but you may
                            enter
                            any price.</p>
                        <p>Change this at any time in Accounts.</p>
                    </div>
            ...
            <div class="row">
                <div class="col-75">
                    ...
                    <label for="box-url">https://boxeon.com/
                        <input id='box-url' type='text' required autocomplete='off' value='' placeHolder='YourCustomURL'
                        name='box_url'></label>
                </div>
            ...
            <div class="row">
                <div class="col-75">
                    <h3>What username do you want for your page?</h3>

                    <input type='text' required autocomplete='off' value='' placeHolder='Example: your YouTube channel name'
                        name='page_name'>
                ...
                <div class="col-75">
                    ...
                    <div>
                        <p>Sell more boxes by offering buyers free
                            shipping. Don't worry - you may save up to 90% on shipping costs by ordering shipping labels
                            on the
                            Ship Boxes page.</p>
                        <p>Change this at any time in Accounts.</p>
                    </div>
            ...
            <div id="curation1" class="row">
                <div class="col-75">
                    ...
                    <div>
                        ...
                        <p>Our research indicates that most people can ship 4 pounds or under at a reasonable enough
                            rate to
                            make a subscription box priced at USD 30 (plus shipping) a sustainable box. If you're unsure
                            of the
            ...
            <div class="hiden row">
                <div class="col-75">
                    ...
                    <div>
                        <p>Shipping carriers need this info to calculate the cost of shipping your boxes. The most
                            common subscription
                            box sizes are 8" x 8" x 4", 10" x 6" x 4", and 9" x 6" x 3". These boxes can be sourced from
                            most
            ...
            <div class="hiden row">
                <div class="col-75">
                    ...
                    <input class='optional' type='number' disabled required name='num_products'
                        placeholder='Number of items per box' min='1' max='25'>
                    <select class='optional' disabled required name='prodname'>
                        ...
                        <option value='DRAPERY_WINDOW_COVERING_AND_UPHOLSTERY'>Drapery, window covering, and upholstery
                        </option>
                        ...
                        <option value='ELECTRICAL_AND_SMALL_APPLIANCE_REPAIR'>Electrical and small appliance repair
                        </option>
                        ...
                        <option value='MOTOR_VEHICLE_SUPPLIES_AND_NEW_PARTS'>Motor Vehicle Supplies and New Parts
                        </option>
                        ...
                        <option value='MUSIC_STORE_INSTRUMENTS_AND_SHEET_MUSIC'>Music store - instruments and sheet
                            music
                        </option>
                        <option value='NETWORKING'>Networking</option>
                        <option value='NEW_AGE'>New Age</option>
                        <option value='NEW_PARTS_AND_SUPPLIES_MOTOR_VEHICLE'>New parts and supplies - motor vehicle
                        </option>
                        ...
                        <option value='PIECE_GOODS_NOTIONS_AND_OTHER_DRY_GOODS'>Piece Goods Notions and Other Dry Goods
                        </option>
                        ...
                        <option value='RELIGION_AND_SPIRITUALITY_FOR_PROFIT'>Religion and spirituality for profit
                        </option>
                        ...
                        <option value='TYPESETTING_PLATE_MAKING_AND_RELATED_SERVICES'>Typesetting, Plate Making, and
                            Related
                        </option>
                ...
                <div class="col-75">
                    ...
                    <div>
                        <p>We will use this info to calculate the cost of shipping to your buyers and
                            ...
                            shipping labels you will need to ship your boxes. If you don't offer free shipping, our
                            algorithm
                            will use your shipping address to calculate the cost of shipping for your buyers during the
                            checkout
                            process.</p>
                        <p>Change this at any time in Accounts.</p>
                    </div>
                    ...
                    <input name='admin_area_1' type='text' class='optional' disabled required value=''
                        placeHolder='State' />
                    <select disabled required name='country_code' class='optional form-control' id='country'>
                        ...
                        <optgroup id='country-optgroup-Asia' label='Asia'>
                            ...
                            <option value='YD' label='Peoples Democratic Republic of Yemen'>People's Democratic Republic
                                of
                                Yemen</option>
