    ...
    <section id="headline">
      <div class="two-col-grid">
        <div>
          ...
          <p id="pitch">The Boxeon Partner Program is sponsoring one hundred content creators to launch their subscription boxes on Boxeon. If you're a creator with 20,000 plus average views and would like to launch a subscription box at no cost to you, apply today.</p>
        ...
        <div id="form-partner-apply-wrapper" class="masthead-forms">
          <h2>Apply now</h2>
          <form id='form-partner-apply' onsubmit='return default;'>
            <fieldset>
    ...
    <section class="section padding-top-6-em">
      <div class="section-inner-grid"> <img src="../assets/images/hero.svg" alt='Why Boxeon'/>
        <div class="secinner">
          ...
          <p>We're offering you a monthly salary of up to $2500 per month with a minimum commitment of three months. Plus, a budget of $15, 000 to finance your subscription box.</p>
        </div>
      </div>
    </section>
    <section class="section">
      <div class="alt-section-inner-grid">
        <div class="secinner">
          ...
          <p>We'll take care of customer service and fulfillment so you can devote your time to being creative.</p>
        </div>
    ...
    <section class="section">
      <div class="alt-section-inner-grid"><img src="../assets/images/gdpr.svg" alt="General Data Protection Regulation" />
        <div class="secinner">
          ...
          <p>You and your fans will enjoy secure transactions via Paypal, World Remit, CashApp, Crypto Currency, and more.</p>
        </div>
      </div>
    </section>
    <section class="section">
