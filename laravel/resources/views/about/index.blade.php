...
@section('content')
    ...
    <main>
        ...
        <section class='section maxw1036'>
            ...
            <div class="pitch">
                <aside class="asides"><h1 class="text-3em">We're a Pan-African cadre with an acute desire to spark industrial revolutions. In service of such, we've created Boxeon to skyrocket the consumption of products manufactured in Africa.</h1> </aside>
            </div>
