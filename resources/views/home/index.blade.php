...
<main class="fadein"><section id="left-aside"></section><aside id="panel">
  ...
  <div id="home-videos-wrapper">
      <div id="52">
        ...
        <img id="play-video" data-video-id="VVilOqCLVPc" class="playbtn" src="../images/playbtn.png" alt="Play video">
        </div>
          <br>
        <p>Jane Doe</p>
        ...
        <img id="play-video" data-video-id="-jn5ttblE9M" class="playbtn" src="../images/playbtn.png" alt="Play video">
        </div>
          <br>
        <p>Kelly Stamps</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras auctor id ligula et tincidunt.</p>
