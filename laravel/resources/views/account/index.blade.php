...
@section('content')
    ...
    <main class='fadein'>
        ...
        <aside id='panel'>
            <div id='module'>
                <h2>Box</h2>
                <form class='form-settings' action='/account/settings/url' method='put'>
                    <input type='text' name='box_url' value='' required placeholder='Url:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <form class='form-settings' action='/account/settings/price' method='put'>
                    <input type='number' name='price' value='' required placeholder='Price:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <form class='form-settings' action='/account/settings/supply' method='put'>
                    <input type='number' name='supply' value='' required placeholder='Supply:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <form class='form-settings' action='/account/settings/shipping' method='put'>
                    <input type='number' name='supply' value='' required placeholder='Shipping:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <form class='form-settings' action='/account/settings/shipping' method='put'>
                    <input type='text' name='url' value='' required placeholder='Youtube video:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <h2>Address</h2>
                <form class='form-settings' action='/settings/address' method='put'>
                ...
                <input name='postal_code' type='text' class='optional'  required value=''
                ...
                <h2>Contact</h2>
                <form class='form-settings' action='/settings/phone' method='put'>
                    <input type='text' name='phone' value='' required placeholder='Phone:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <form class='form-settings' action='/settings/email' method='put'>
                    <input type='text' name='email' value='' required placeholder='Email:'>
                    <input class='clearbtn' type="submit" value='Update'>
                </form>
                <h2>Account</h2>
                <a href='#'>Suspend my account</a>
            </div>
        </aside>
