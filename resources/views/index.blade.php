...
@section('content')
    ...
    <main> <a id='whatis' href='#whatis'></a>
      ...
      <section class="section">
        <div class="section-inner-grid"> <img src="assets/images/winning.svg" alt="printing money"/>
          <div class="secinner">
      ...
      <section class="section">
        <div class="alt-section-inner-grid">
          ...
          <img src="assets/images/car.svg" alt="Shipping" /> </div>
      </section>
      <section class="section">
        <div class="alt-section-inner-grid"><img src="assets/images/gdpr.svg" alt="Safety first" />
          <div class="secinner">
