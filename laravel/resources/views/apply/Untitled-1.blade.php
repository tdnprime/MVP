...
@section('title', 'Boxeon .com Creator Application')
@section('content')
    <main>
        ...
        <aside id="panel">
            <div id="module">
                ...
                <div class="masthead-forms">
                    <div class="row">
                        <div class="col-75">
                            <h2 id='apply' href='#apply'>Make offer</h2>
                            <p>Let us know a bit about you, how you'd like to promote our subscription boxes, and how much you'd like to be paid.</p>
                            <p>We typically respond to offers within 7 business days via email and WhatsApp.</p>
                        </div>
                    </div>
                    <form id='form-partner-apply' action="/partner/apply" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-75">
                                    ...
                                    <select class="margin-top-2-em" required name="platform">
                                    ...
                                    <input class="margin-top-2-em" required type='number' name='views'
                                        placeholder="Average views" />
                                    <select required name="country_code" class="form-control margin-top-2-em" id="country">
                        ...
                        <br>
                        <fieldset>
                            <p>Please tell us your offer.</p>
                            <div class="row">
                                <div class="col-75">
                                    <select class="margin-top-2-em" required name="project">
                                        <option value="" invalid>Select the help you're offering</option>
                                        <option value="livestream">Livestream</option>
                                        <option value="video">Pre-recorded video</option>
                                        <option value="post">Post</option>
                                        <option value="other">Other</option>
                                    </select>
                                    <input type='text' name="price" placeholder="Your price in USD">
                                </div>
                            </div>
                        </fieldset>
                        <div class="row">
