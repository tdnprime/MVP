...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::get('/checkout/address', 'App\Http\Controllers\LabelsController@showAddress')->name('labels.purchase');
    Route::post('/checkout/labels', 'App\Http\Controllers\LabelsController@rates')->name('labels.purchase');
