...
<main>
      ...
      <ul>
        <li>Complete a transaction, provide goods or services you requested, or comply with our promises to you in the <a class='one-em-font primary-color'' href='/terms/'>Terms of Use</a> or other contract you have with us</li>
      ...
      <p>Depending on where you live and what type of account you use, you may have different rights and choices for managing your personal data. For example, certain State privacy laws do not apply to personal data collected, processed, or disclosed by a financial institution according to federal laws, such as the Gramm-Leach-Bliley Act. Consumers may read our <a class='one-em-font primary-color'' href='#cpn'>Consumer Privacy Notice</a> for more information about their rights under US federal law.</p>
      ...
      <p>You may choose to limit the personal data you provide when our apps or third-party services request it. To help make choices that are right for you, it’s important to understand that personal data helps us provide a richer, more personalized experience for you. Also, some personal data is required for our services to function at all.</p>
      <p> For example, creating an account with us requires your personal data. If you choose not to provide information that is required for an account to function, like your name and email address, we will not be able to create an account for you.</p>
      <h2>Choose how connected accounts collect and use personal data</h2>
      <p>If you connect your account to a third-party service, you may be able to manage how your personal data is collected, used, and shared by them. Read the third parties’ privacy policies to see the choices they offer you.</p>
      <p> You can control which third-party services you connect to your account and what personal data they can collect about you. For example, to manage the permissions, go to the Settings in your Boxeon account.</p>
      <h2>Choose how we communicate with you</h2>
      <p>Your choices about how we communicate with you differ depending on the purpose of the message and how it is delivered. Some messages are considered optional and some are necessary for you to manage your accounts with us. We use email, text messages, push notifications on your mobile device, and even paper mail depending on the situation and your preferences.</p>
      <p>You can click the unsubscribe link in a marketing email, opt out of a text message by replying “STOP,” or turn off notifications on your device. You can also change your account’s notification settings or the notification preferences on your device.</p>
      <p>You won’t be able to opt out of messages that are considered necessary for you to manage your account, such as receipts and emails that alert you to changes in your account’s status that require your attention. You may be able to decide how we send those messages, such as by email, text message, or a notification on your mobile device.</p>
      <h2>The personal data we collect</h2>
      <p>We may collect your personal data when you register for or use our services, such as when you create an account, make a payment, or interact with our third-party services. </p>
      <p>If you use our services without creating or logging into an account, we’ll still collect personal data, which may include your payment information, device information, and location. When you use our services without creating or logging into an account, we will use this information to process transactions, prevent fraud and comply with the law. We may connect this information with your account, if you have one or if you create an account at a later date.</p>
      ...
      <ul>
        ...
        <li>If you have an account with Boxeon, we will associate information from all these sources with your account to improve your experience and for compliance and analytics purposes. </li>
      </ul>
      <p>We do not knowingly collect personal information from people who are not allowed to use our sites and services, such as children under the age of 13. Contact us if you believe that we’ve mistakenly collected personal data from someone not allowed to use our services. We’ll delete it immediately, unless we’re legally required to keep it.</p>
      ...
      <ul>
        <li> Run our sites and provide better services, for example to help you send or recieve money, make purchases, show you your account information, verify access to your account, and keep your account and payment information up to date.</li>
      ...
      <ul>
        ...
        <li>Third-party tools used to help fight spam and abuse. For instance, we use ReCaptcha to help determine whether you’re a person or a computer. When you use ReCaptcha, your personal data is subject to Google’s <a class='one-em-font primary-color'' href='https://policies.google.com/privacy' title="Google Privacy">Privacy Policy</a> and <a class='one-em-font primary-color'' href="https://policies.google.com/terms" title="Google Terms of Use">Terms of Use</a>.</li>
      </ul>
      ...
      <p>Helping to keep your personal data safe against loss, misuse, unauthorized access, disclosure, and alteration is our top priority.</p>
      <p>To protect your personal data, we rely on technical, physical, and administrative security measures that include:</p>
      <ul>
        <li>Firewalls</li>
        <li>Data encryption</li>
        <li>Physical access controls at data centers</li>
      </ul>
      <p>While we protect our systems and services, you’re responsible for keeping your password(s) and account information private. You are also responsible for making sure your personal information is accurate and up to date.</p>
      <p>If your account is closed, we may keep your personal data and other information as required by law and according to our data retention policy. If we do, we’ll continue to handle it as we describe in this statement.</p>
      <h2> How this statement changes over time</h2>
      <p>We’ll make changes to this privacy statement from time to time. This helps us stay up to date with changes to our business and the most current laws. After a new version is published, we’ll collect, store, use, and protect your personal data as we outline in that revised statement.</p>
      <p>If the new version reduces your rights or increases your responsibilities, we’ll post it on our website at least 21 days before it becomes effective.</p>
      ...
      <table>
        <tbody>
          <tr>
            <th style="width:23.0%;"> <p>FACTS</p>
            </th>
            <th> <p><strong>WHAT DOES Boxeon DO WITH YOUR PERSONAL INFORMATION?</strong></p>
            </th>
          </tr>
          <tr>
      ...
      <table>
        <tbody>
          <tr>
            <th> <p>Reasons we can share your personal information</p>
            </th>
            <th> <p>Does Boxeon share?</p>
            </th>
            <th> <p>Can you limit this sharing?</p>
            </th>
          </tr>
          <tr>
      ...
      <table>
        <tbody>
          <tr>
            ...
            <th style="text-align:left;font-weight:normal"> <p>Call our customer service at  1-646-450-4671‬ or visit us at <a class='one-em-font primary-color'' href="https://boxeon.com/contact"><strong>https://boxeon.com/contact</strong></a>. </p>
            </th>
          </tr>
        </tbody>
      </table>
