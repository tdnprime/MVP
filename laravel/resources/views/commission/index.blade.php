...
@section('content')
    ...
    <div id="masthead">
        <section id="headline">
            ...
            <a class="button" href="/commission/home"> Get started </a>
    ...
    <main> <a id='whatis' href='#whatis'></a>
        <aside class="asides">
            ...
            <p class="center font-1-5-em"><a href='/commission/home'>Get started</a> by inventing creators with your invitation link. We'll automatically credit your account
        ...
        <section class="section"> <br>
            <div class="centered margin-bottom-10-em">
              ...
              <br>
              <a class="button" href="/commission/home"> Get started </a> </div>
          </section>
