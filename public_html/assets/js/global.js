...
Shipping = {
  ...
  buildAddressInputForm: function (creator_uid) {
    ...
    document.getElementById("m-body").innerHTML =
      ...
      + "<input type='text' name='cpf' placeHolder='Brazil CPF (optional)' value=''></input>"
      ...
      + "<label>No <input class='centered' type='radio' required name='billing' value='0'></input></label></fieldset>"
      + "<fieldset><br>"
    ...
    for (var i = 0; i < nl.length; i++) {
      ...
      if (nl[i].getAttribute('name')) {
        ...
        if(key == "billing"){
          ...
          if(nl[i].checked == false){

            //Serve billing address UI

          }
          return;
        }

        if (value == "" && key !== "address_line_2" && key !== "cpf") {
